...
## com.lort533.Main application
For information about main application, see [com.lort533.Main project](https://github.com/jindrapetrik/jpexs-decompiler)

## Library JAR file
com.lort533.Main FFDec library JAR file is named `ffdec_lib.jar`.
